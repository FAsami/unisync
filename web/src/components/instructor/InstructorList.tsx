...
const GET_INSTRUCTORS = gql`
  query GetInstructors {
    user_account(
      where: {
        _or: [{ role: { _eq: "instructor" } }, { role: { _eq: "admin" } }]
      }
...
const CREATE_INSTRUCTOR = gql`
  mutation CreateInstructor($account: user_account_insert_input!) {
...
const UPDATE_INSTRUCTOR = gql`
  mutation UpdateInstructor($id: uuid!, $changes: user_account_set_input!) {
    update_user_account_by_pk(pk_columns: { id: $id }, _set: $changes) {
      id
      phone
      email
      role
...
const UPDATE_PROFILE = gql`
  mutation UpdateProfile($id: uuid!, $changes: user_profile_set_input!) {
    update_user_profile_by_pk(pk_columns: { id: $id }, _set: $changes) {
      id
      first_name
      last_name
      student_id
    ...
    <div>
      ...
      >
        <Form form={profileForm} layout='vertical'>
          ...
          <Form.Item name='student_id' label='Employee/Instructor ID'>
